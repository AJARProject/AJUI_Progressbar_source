...
Case of 
	...
	: ($evt=On Clicked:K2:4)
		$instanceName_t:=Form:C1466.mycpb.CPBPictFormObjName()
		...
		Else 
			...
			Form:C1466.mycpb.CPBTitle("Please")
			Form:C1466.mycpb.CPBSubtitle("Wait")
			Form:C1466.mycpb.LaunchCircularBarberShop()
		End if 
