//%attributes = {"invisible":true}
  // AJUI_GetSet_CPBBarSpeed ( $barSpeed_r ) -> return
  //
...
If (False:C215)
	  ...
	  // Date and time: 28.05.19, 14:03:14
	  // ----------------------------------------------------
	  // Method: AJUI_GetSet_CPBBarSpeed
	  // Description
	  // 
	  //
	  // ----------------------------------------------------
...
If (Count parameters:C259=0)
	$0:=This:C1470.cpb.bar.speed
Else 
	$barSpeed_r:=$1
	If ($barSpeed_r>0) & ($barSpeed_r<=10)
		This:C1470.cpb.bar.speed:=$barSpeed_r
	End if 
End if 
